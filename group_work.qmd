...
- Popularity = 1 * 30_day_booking_rate + 10 * average_daily_review_count

                + 0.5 * superhost_or_not
...
- Satisfaction = 1.5 * accuracy + 2 * cleanliness + 1 * check in

                  + 1 * communication + 0.5 * location + 1 * value
...
axs[1].set_title('Figure 2-d  "Heat1" with highlighted "Satisfaction5"')
